...
//let slice=text.slice(3,20);
//console.log(slice);

//let substrl=text.substrl(3,5);
//console.log(substrl);

// let b="20";
// let a=b.padStart(4,"0");
// console.log(a);

// let text = "5";
// let b = text.padEnd(4,"0");
// console.log(b);
...
// let a = "Please visit Microsoft!";
// let b = a.replace("Microsoft", "W3Schools");
// console.log(b);
